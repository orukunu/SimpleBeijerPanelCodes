...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class LicenseRootComponent : Neo.ApplicationFramework.Tools.License.LicenseRootComponent, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage
	{
		...
		private void InitializeComponent()
		{
			...
			PanelHardwareIdList4.IdList.Add(26);
			PanelHardwareIdList4.IdList.Add(27);
			PanelHardwareIdList4.IdList.Add(28);
			PanelHardwareIdList4.IdList.Add(38);
			PanelHardwareIdList4.IdList.Add(39);
			PanelHardwareIdList4.IdList.Add(40);
			PanelHardwareIdList4.IdList.Add(41);
			PanelHardwareIdList4.IdList.Add(42);
			PanelHardwareIdList4.IdList.Add(43);
			PanelHardwareIdList4.IdList.Add(47);
			PanelHardwareIdList4.IdList.Add(48);
			PanelHardwareIdList4.IdList.Add(48);
			PanelHardwareIdList5.IdList.Add(29);
			PanelHardwareIdList5.IdList.Add(30);
			PanelHardwareIdList5.IdList.Add(31);
			PanelHardwareIdList6.IdList.Add(18);
			PanelHardwareIdList6.IdList.Add(19);
			PanelHardwareIdList7.IdList.Add(78);
			PanelHardwareIdList7.IdList.Add(79);
			PanelHardwareIdList7.IdList.Add(80);
			PanelHardwareIdList7.IdList.Add(128);
			PanelHardwareIdList7.IdList.Add(129);
			PanelHardwareIdList7.IdList.Add(130);
			PanelHardwareIdList7.IdList.Add(131);
			PanelHardwareIdList7.IdList.Add(132);
			PanelHardwareIdList7.IdList.Add(133);
			PanelHardwareIdList7.IdList.Add(134);
			PanelHardwareIdList7.IdList.Add(135);
			PanelHardwareIdList7.IdList.Add(137);
			PanelHardwareIdList7.IdList.Add(138);
			PanelHardwareIdList7.IdList.Add(139);
			PanelHardwareIdList7.IdList.Add(140);
			PanelHardwareIdList7.IdList.Add(141);
			PanelHardwareIdList7.IdList.Add(142);
			PanelHardwareIdList7.IdList.Add(143);
			PanelHardwareIdList7.IdList.Add(144);
			PanelHardwareIdList7.IdList.Add(145);
			PanelHardwareIdList7.IdList.Add(148);
			PanelHardwareIdList7.IdList.Add(149);
			PanelHardwareIdList7.IdList.Add(150);
			PanelHardwareIdList7.IdList.Add(151);
			PanelHardwareIdList7.IdList.Add(152);
			PanelHardwareIdList7.IdList.Add(153);
			PanelHardwareIdList7.IdList.Add(154);
			PanelHardwareIdList7.IdList.Add(155);
			PanelHardwareIdList7.IdList.Add(156);
			PanelHardwareIdList7.IdList.Add(157);
			PanelHardwareIdList7.IdList.Add(180);
			PanelHardwareIdList7.IdList.Add(181);
			PanelHardwareIdList7.IdList.Add(182);
			PanelHardwareIdList7.IdList.Add(184);
			PanelHardwareIdList7.IdList.Add(185);
			PanelHardwareIdList7.IdList.Add(187);
			PanelHardwareIdList7.IdList.Add(188);
			PanelHardwareIdList7.IdList.Add(189);
			PanelHardwareIdList7.IdList.Add(190);
			PanelHardwareIdList7.IdList.Add(192);
			PanelHardwareIdList7.IdList.Add(193);
			PanelHardwareIdList7.IdList.Add(195);
			PanelHardwareIdList7.IdList.Add(196);
			PanelHardwareIdList7.IdList.Add(197);
			PanelHardwareIdList7.IdList.Add(199);
			PanelHardwareIdList7.IdList.Add(200);
			...
			this.PanelHardwareIDs.Add(Neo.ApplicationFramework.Interfaces.PanelTypeGroup.TxB, PanelHardwareIdList4);
			this.PanelHardwareIDs.Add(Neo.ApplicationFramework.Interfaces.PanelTypeGroup.TxC, PanelHardwareIdList5);
			this.PanelHardwareIDs.Add(Neo.ApplicationFramework.Interfaces.PanelTypeGroup.QTermAx, PanelHardwareIdList6);
			this.PanelHardwareIDs.Add(Neo.ApplicationFramework.Interfaces.PanelTypeGroup.X2, PanelHardwareIdList7);
			this.ProductFamilyRegistryPath = "SOFTWARE\\Beijer Electronics AB\\iX Developer 2.40 SP2\\Install";
			this.ProjectPanelName = "X2 base 10";
